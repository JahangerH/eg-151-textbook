...
There will be one lecture a week on **Monday** at **02:00 pm** on the architecture of the target microcontroller. This will be delivered on-campus and will be supported by on-demand after-class formative tests which aim to reinforce the knowledge gained in lectures by means of [retrieval practice](https://youtu.be/gncl5Fn7CJ4).
...
The lecture course and the laboratory work will be assessed by an online class test worth 35%. We anticipate that the class test will be held between  **12 PM -- 2 pm Friday 5th December in The College 025 PC (Bay)** in Week 10 with a resit being held in week commencing 20th January 2025.
